...
$filePath = '../documents/excel_new_data_source/tgp_sales.xlsx'; // Path to the Excel file
...
if ($sheet) {
    ...
    foreach ($data as $row) {
        ...
        foreach ($keys as $index => $key) {
            ...
            if ($value !== null) {
                // You can map custom column names here
                switch ($key) {
                    case 'Month and Year':
                        $rowData['Month and Year'] = $value;
                        break;
                    case 'Name (item)':
                        $rowData['Name (item)'] = $value;
                        break;
                    case 'Quantity':
                    ...
                    case 'Sales':
                        ...
                        break;
                    default:
                        // Handle any additional columns if needed, or ignore them
                        break;
                }
            }
        }
